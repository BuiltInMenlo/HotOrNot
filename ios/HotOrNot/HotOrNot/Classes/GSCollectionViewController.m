...
- (id)init {
	...
	if ((self = [super init])) {
		...
		[[NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"GSMessengers" ofType:@"plist"]] enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
...
- (void)viewDidLoad {
	...
	[_closeButton setBackgroundImage:[UIImage imageNamed:@"backButton_nonActive"] forState:UIControlStateNormal];
	[_closeButton setBackgroundImage:[UIImage imageNamed:@"backButton_Active"] forState:UIControlStateHighlighted];
