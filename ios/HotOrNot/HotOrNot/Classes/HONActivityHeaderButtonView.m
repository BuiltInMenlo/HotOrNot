...
- (id)initWithTarget:(id)target action:(SEL)action {
	if ((self = [super initWithFrame:CGRectMake(0.0, 0.0, 93.0, 44.0)])) {
		...
		_button.frame = CGRectFromSize(self.frame.size);//CGRectMake(0.0, 0.0, 93.0, 44.0);
...
//		_activityBGImageView.hidden = YES;
		...
		_activityTotalLabel = [[UILabel alloc] initWithFrame:CGRectFromSize(CGSizeMake(kMaxActivityWidth, 44.0))];
