...
typedef NS_ENUM(NSInteger, HONAnalyticsEventCollectionType) {
	HONAnalyticsEventCollectionTypeFirstRun = 0,
	HONAnalyticsEventCollectionTypeMainView,
	HONAnalyticsEventCollectionTypeSettings,
	HONAnalyticsEventCollectionTypeCompose,
	HONAnalyticsEventCollectionTypeSubDetails
};
