...
//	NSLog(@"\t--GRID IMAGE(%d):[%@]", _participantCounter, [NSString stringWithFormat:@"%@",  [opponentVO.imagePrefix stringByReplacingOccurrencesOfString:@"http://d1fqnfrnudpaz6.cloudfront.net/" withString:@""]]);
