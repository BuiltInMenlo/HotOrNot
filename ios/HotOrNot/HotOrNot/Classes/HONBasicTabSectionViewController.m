//
//  HONBasicTabSectionViewController.m
//  HotOrNot
//
...
#import "HONBasicTabSectionViewController.h"
...
@interface HONBasicTabSectionViewController () <EGORefreshTableHeaderDelegate, HONTutorialViewDelegate>
@end


@implementation HONBasicTabSectionViewController
...
//	[headerView addButton:[[HONMessagesButtonView alloc] initWithTarget:self action:@selector(_goMessages)]];
	[headerView addButton:[[HONCreateSnapButtonView alloc] initWithTarget:self action:@selector(_goSelfieCamera)]];
