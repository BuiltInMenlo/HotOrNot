...
//	[_submitParams setValue:channelName forKey:@"img_url"];
	...
	[[HONAPICaller sharedInstance] submitStatusUpdateWithDictionary:_submitParams completion:^(NSDictionary *result) {
		if ([[result objectForKey:@"result"] isEqualToString:@"fail"]) {
			...
			pasteboard.string = [NSString stringWithFormat:@"http://popup.vlly.im/%d/", [[result objectForKey:@"id"] intValue]];
			
			[[[UIAlertView alloc] initWithTitle:@"Your DOOD chat link has been copied to your clipboard!"
										message:[NSString stringWithFormat:@"Share your DOOD chat link with friends for them to join. http://popup.vlly.im/%d/", [[result objectForKey:@"id"] intValue]]
									   delegate:nil
