...
@interface HONInvitePopularViewController () <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate, HONPopularUserViewCellDelegate>
...
@implementation HONInvitePopularViewController
