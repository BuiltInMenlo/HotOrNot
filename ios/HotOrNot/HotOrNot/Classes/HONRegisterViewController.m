...
- (void)loadView {
	...
	[[HONImageBroker sharedInstance] maskView:_avatarImageView withMask:[UIImage imageNamed:@"thumbPhotoMask"]];
...
//	[self.view addSubview:_addAvatarButton];
	...
	_usernameTextField.placeholder = @"Enter name";
	_usernameTextField.text = @"";
...
//	[self.view addSubview:_clubNameLabel];
	...
	[_callCodeButton setTitleEdgeInsets:UIEdgeInsetsMake(3.0, -2.0, 0.0, 0.0)];
