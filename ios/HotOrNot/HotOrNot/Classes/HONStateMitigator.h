...
extern NSString * const kStateMitigatorViewStateNameHome;
extern NSString * const kStateMitigatorViewStateNameFriends;
extern NSString * const kStateMitigatorViewStateNameSettings;
extern NSString * const kStateMitigatorViewStateNameStatusUpdate;
...
extern NSString * const kStateMitigatorTotalCounterNameHomeTab;
extern NSString * const kStateMitigatorTotalCounterNameHomeTabRefresh;
...
extern NSString * const kStateMitigatorTotalCounterNameStatusUpdate;
