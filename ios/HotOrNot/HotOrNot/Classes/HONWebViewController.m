...
- (void)loadView {
	...
	[_doneButton setBackgroundImage:[UIImage imageNamed:@"doneGreenButton_nonActive"] forState:UIControlStateNormal];
	[_doneButton setBackgroundImage:[UIImage imageNamed:@"doneGreenButton_Active"] forState:UIControlStateHighlighted];
