...
- (void)loadView {
	...
	_webView = [[UIWebView alloc] initWithFrame:CGRectMake(0.0, 45.0, 320.0, [UIScreen mainScreen].bounds.size.height - 45.0)];
	...
	HONHeaderView *headerView = [[HONHeaderView alloc] initAsModalWithTitle:_headerTitle hasTranslucency:NO];
