...
- (id)init {
	if ((self = [super initWithFrame:[UIScreen mainScreen].bounds])) {
        ...
        UIImageView *frameModal = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"modalReviewBackground"]];
        ...
        UIImageView *reviewImage = [[UIImageView alloc] initWithFrame:CGRectMake(20,61,286,350)];
        reviewImage.image = [UIImage imageNamed:@"appStoreReview"];
		[frameModal addSubview:reviewImage];
...
//		[startScrollView addSubview:stickerImage3];
		...
		reviewButton.frame = CGRectMake(20.0, 468.0, 560/2, 50.0);
		[reviewButton setBackgroundImage:[UIImage imageNamed:@"tapToReview_nonActive"] forState:UIControlStateNormal];
		[reviewButton setBackgroundImage:[UIImage imageNamed:@"tapToReview_Active"] forState:UIControlStateHighlighted];
		[reviewButton addTarget:self action:@selector(_goInvite) forControlEvents:UIControlEventTouchDown];
