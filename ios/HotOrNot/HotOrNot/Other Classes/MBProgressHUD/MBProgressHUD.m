...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.labelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];//[UIFont fontWithName:@"HelveticaNeue" size:14.0];//
		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];//[UIFont fontWithName:@"HelveticaNeue" size:10.0];//
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
//CGSize labelSize = [label.text sizeWithAttributes:<#(NSDictionary *)#>:label.font];
