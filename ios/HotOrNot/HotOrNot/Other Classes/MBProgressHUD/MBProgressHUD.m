...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.labelFont = [UIFont fontWithName:@"HelveticaNeue" size:14.0];//[UIFont boldSystemFontOfSize:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName:@"HelveticaNeue" size:10.0];//[UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
