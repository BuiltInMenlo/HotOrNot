...
static const CGFloat kDetailsLabelFontSize = 16.f; // 12.f
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.labelFont = [UIFont systemFontOfSize:kLabelFontSize];// boldSystemFontOfSize:kLabelFontSize];//[UIFont fontWithName:@"HelveticaNeue" size:14.0];//
		self.detailsLabelFont = [UIFont systemFontOfSize:kDetailsLabelFontSize];// boldSystemFontOfSize:kDetailsLabelFontSize];//[UIFont fontWithName:@"HelveticaNeue" size:10.0];//
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
		self.dimBackground = NO;
		self.margin = 25.0f;//20.0f;
		self.graceTime = 0.0f;
