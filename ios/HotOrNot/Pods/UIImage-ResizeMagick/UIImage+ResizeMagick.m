...
- (UIImage *) resizedImageByMagick: (NSString *) spec
{
    ...
    if([spec hasSuffix:@"!"]) {
        ...
        NSUInteger width = [[NSNumber numberWithLongLong:[[widthAndHeight objectAtIndex: 0] longLongValue]] unsignedIntegerValue];
        NSUInteger height = [[NSNumber numberWithLongLong:[[widthAndHeight objectAtIndex: 1] longLongValue]] unsignedIntegerValue];
    ...
    if ([widthAndHeight count] == 1) {
        return [self resizedImageByWidth:[[NSNumber numberWithLongLong:[spec longLongValue]] unsignedIntegerValue]];
    }
    if ([[widthAndHeight objectAtIndex: 0] isEqualToString: @""]) {
        return [self resizedImageByHeight:[[NSNumber numberWithLongLong:[[widthAndHeight objectAtIndex: 1] longLongValue]] unsignedIntegerValue]];
    }
