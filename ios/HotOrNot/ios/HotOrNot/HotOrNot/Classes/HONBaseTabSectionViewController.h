//
//  HONBaseTabSectionViewController.h
//  HotOrNot
//
...
@class HONBaseTabSectionViewController;
@interface HONBaseTabSectionViewController : UIViewController <UITableViewDataSource, UITableViewDelegate> {
