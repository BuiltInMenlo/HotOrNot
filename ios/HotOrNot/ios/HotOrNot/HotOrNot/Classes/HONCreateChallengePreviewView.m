...
@interface HONCreateChallengePreviewView () <HONEmotionsPickerViewDelegate>
...
- (id)initWithFrame:(CGRect)frame withPreviewImage:(UIImage *)image asSubmittingType:(HONCameraSubmitType)selfieSubmitType withSubject:(NSString *)subject withRecipients:(NSArray *)recipients {
	if ((self = [super initWithFrame:frame])) {
		...
		_creatorSubjectName = (_selfieSubmitType == HONCameraSubmitTypeReplyChallenge) ? [NSString stringWithFormat:@"%@ : ", _subjectName] : @"";
