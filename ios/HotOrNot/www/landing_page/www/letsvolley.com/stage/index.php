...
<head>
	<link rel="image_src" href="http://letsvolley.com/_assets/img/fbpreview.jpg" />
	<meta charset="UTF-8">
	...
	<title>Volley - a new way to connect and trade pics</title>
...
<body>
	...
	<script>(function(d, s, id) {
	  ...
	  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=444560008924397";
	...
	<div id="primary_content" class="clearfix">
		<div class="content">
			...
			<nav>
				<ul>
					<li><a href="http://kr.letsvolley.com" target="_blank">Korea</a></li>
					<li><a href="http://jp.letsvolley.com" target="_blank">Japan</a></li>
					<li><a href="http://id.letsvolley.com" target="_blank">Indonesia</a></li>
					<li><a href="http://hk.letsvolley.com" target="_blank">China</a></li>
				</ul>
			</nav>
			
			<header>
				<h1><a href="http://www.letsvolley.com/"><img src="_assets/img/logo_hiRes.png" width="197" height="87"></img></a></h1>
				<h2>a new way to connect and trade pics</h2>
			</header>
	...
	<div id="secondary_content" class="clearfix">
		<div class="content clearfix">
			...
			<div class="about">
				<br></br>
				<p>Volley is a fast and fun way to snap with friends & meet new people. No fakes allowed, just a forward facing camera and the best you.<br></br>Currently in Private Beta</p>
				<p><div class="fb-like" data-href="http://letsvolley.com" data-send="true" data-layout="button_count" data-width="100" data-show-faces="false"></div><br><a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.letsvolley.com" data-via="GetVolley">Tweet</a>
	...
	<div id="features">
		<div class="content clearfix">
			...
			<div class="primary">
				...
				<ul>
					<li>Trade pics worldwide</li>
					<li>Snap@anyone including celebrities</li>
					<li>A camera to camera experience</li>
