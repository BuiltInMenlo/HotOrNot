...
<html>
    <head>  
        <title>SelfieSnap - Selfies - <?php echo $UNIQUE_ID;?></title>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-16">
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
		<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
		<meta name="apple-mobile-web-app-capable" content="yes" />
		<meta name="kik-more" content="<?php echo $HOST;?>">
		<meta name="kik-prefer" content="true">
		<meta name="description" content="Join <?php echo $UNIQUE_ID;?>">
        ...
        <!--
		<script src="http://<?php echo $HOST;?>/selfiesnap/js/cards.js"></script>
		-->
			...
			<script id='code_1'>
				...
				*/
				...
				function getCardBody(){
					var msgs = [
						...
						'HMU, shoutouts on Selfiesnap',
						'u invite me to Selfiesnap?',
						'cute pics :) Selfiesnap me?',
						'lots of cute selfies here :)',
						'I AM A SELFIE QUEEN :)',
						'did you see this app OMG!! lol',
						'da bomb for selfies :)',
						'soooo love this app :)',
						'ur cute want to trade on Selfiesnap',
						'Selfiesnap invite only',
						'Celebs are joining now too',
						'Selfiesnap YES! finally :)',
						'So many cute selfies here ...',
						'IN DA CLUB lol the Selfiesnap',
						"I can't wait to share this app at school",
						'wanna Selfiesnap me?',
						'Reply and like my selfies on Selfiesnap :)',
						'Do you have this app yet?',
						'Selfiesnap 4 DAYZ :)',
						'OMG, this is so cute.. this app :)',
						'Selfiesnap hmu up there :)',
				...
				*/
				...
				function handleSelfies(result, user) {
					...
					var button0 = '<a href="http://taps.io/J0Ig"><img id="imgBtnDownld" src="http://kik.vlly.im/images/downloadButton.png"/></a>';
