...
<head>
	...
	<title>Kodee - an open snap for snap community</title>
...
<body>
	...
	<div id="primary_content" class="clearfix">
		<div class="content">
			...
			<header>
				<h1>kodee</h1>
				<h2>an open snap for snap community</h2>
			</header>
	...
	<div id="secondary_content">
		<div class="content">
			...
			<div class="phones">
				<img src="_assets/img/phones.png" alt="" />
			</div>
		
			<div class="about">
				<p>Kodee is a fast and fun way to snap with friends & meet new people. No fakes allowed, just a forward facing camera and the best you.</p>
