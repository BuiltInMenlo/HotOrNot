...
$queue_position = number_format(17525 + ($_GET['result'] * (rand(33, 67) * 0.01)));
		...
		<div class="content">
			...
			<div id="signup_form">
				...
				<form method="post" action="./submit.php?a=2">
					...
					<h3>There are <?php echo ($queue_position); ?> people in front of you to get Volley. Want faster access?</h3>
					<p>Invite your friends to move up in line...</p>
